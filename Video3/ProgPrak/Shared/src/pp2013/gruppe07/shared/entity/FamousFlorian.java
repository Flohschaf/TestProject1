 ...
 *  FamousFlorian
 */
public class FamousFlorian extends Hero{

	//nahkampf
		//first skill guitarre spielen und musik lockt gegner an
		//second skill heilt sich selbst
		//third skill spiet einen hohen ton, stun
		
	public FamousFlorian(UUID id,int x, int y,Team team,boolean isHuman) {
		super(id,x, y,team,isHuman,Heronames.FAMOUS_FLORIAN,1,50);
		heroname="flamourian";
		fightart="sword";
	
		 skillNames[0]="Schoenes Lied";
		 skillNames[1]= "Auszahlung";
		 skillNames[2]="hoher Ton";
