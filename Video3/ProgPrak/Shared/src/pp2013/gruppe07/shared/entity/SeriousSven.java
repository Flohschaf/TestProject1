 ...
 *
 */
public class SeriousSven extends Hero{

//	/fernkampf
	//first skill schutzschild, erhoeht die verteidigung und angriff
		//second skill schiesst und verlangsamt damit die gegener wenn er trifft
		//third skill schiesstbetaeubenden pfeil
		
	public SeriousSven(UUID id,int x, int y,Team team,boolean isHuman) {
		super(id,x, y,team,isHuman,Heronames.SERIOUS_SVEN,4,50);
		heroname="General Hate";
		fightart="arrow";
//		IMAGE = Toolkit.getDefaultToolkit().getImage( "Images/Svenkleinlinks.png" );
//		IMAGE2 = Toolkit.getDefaultToolkit().getImage( "Images/Svengross.png" );
//		IMAGE3 = Toolkit.getDefaultToolkit().getImage( "Images/Svenkleinrechts.png" );
